...
class gquiz_import_form extends moodleform {
    public function definition() {
        global $CFG;
        $mform =& $this->_form;

        $strdeleteolditmes = get_string('delete_old_items', 'gquiz').
                             ' ('.get_string('oldvalueswillbedeleted', 'gquiz').')';

        $strnodeleteolditmes = get_string('append_new_items', 'gquiz').
                               ' ('.get_string('oldvaluespreserved', 'gquiz').')';
