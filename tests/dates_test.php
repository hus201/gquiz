...
/**
 * Contains unit tests for mod_gquiz\dates.
 *
 * @package   mod_gquiz
 * @category  test
...
/**
 * Class for unit testing mod_gquiz\dates.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates_test extends advanced_testcase {
     ...
     * @param int|null $timeopen The "allow answers from" time in the gquiz activity.
     * @param int|null $timeclose The "allow answers to" time in the gquiz activity.
    ...
    public function test_get_dates_for_module(?int $timeopen, ?int $timeclose, array $expected) {
        ...
        $gquiz = $this->getDataGenerator()->create_module('gquiz', $data);
