@mod @mod_gquiz
Feature: Show users who have not responded to the gquiz survey
  In order to harass students about completing the gquiz
  As a teacher
  ...
  Scenario: See users who have not responded
    ...
    # Go in as student 1 and do the gquiz.
    And I am on the Frogs "gquiz activity" page logged in as student1
    ...
    And I am on the Frogs "gquiz activity" page logged in as teacher1
