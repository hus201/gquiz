@mod @mod_gquiz
Feature: Mapping courses in a gquiz
  In order to collect the same gquiz about multiple courses
  As a manager
  I need to be able to map site gquiz to courses
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | gquiz   | Course gquiz  | Acceptance test site | gquiz0 | 1         | 1             | 1       |
      | gquiz   | Another gquiz | C1                   | gquiz1 | 1         | 1             | 0       |
  ...
  Scenario: Course gquiz can not be mapped
    And I log in as "manager"
    And I am on "Course 1" course homepage
    And I follow "Another gquiz"
    And I should not see "Mapped courses"
    And I should not see "Map gquiz to courses"

  @javascript
  Scenario: Site gquiz is not mapped to any course
    And I log in as "user1"
    And I am on site homepage
    And I follow "Course gquiz"
    And I follow "Answer the questions"
    And I should see "Acceptance test site" in the ".gquiz_form" "css_element"
    ...
    And I am on "Course 1" course homepage
    And I click on "Course gquiz" "link" in the "gquiz" "block"
    And I follow "Answer the questions"
    And I should not see "Acceptance test site" in the ".gquiz_form" "css_element"
    And I should see "C1" in the ".gquiz_form" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
    ...
    And I should see "All courses" in the "#gquiz_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=option]" "css_element"
    And I show chart data for the "multichoicerated" gquiz
    ...
    And I press "Filter"
    And I should see "Course 1" in the "#gquiz_course_filter [data-fieldtype=autocomplete] .form-autocomplete-selection [role=option]" "css_element"
    And I show chart data for the "multichoicerated" gquiz
  ...
  @javascript
  Scenario: Site gquiz is mapped to courses
    And I log in as "manager"
    And I am on site homepage
    And I follow "Course gquiz"
    And I follow "Map gquiz to courses"
    ...
    And I am on site homepage
    And I follow "Course gquiz"
    And I should see "You can only access this gquiz from a course"
    And I should not see "Answer the questions"

    And I am on "Course 1" course homepage
    And "gquiz" "block" should not exist
    And I should not see "Course gquiz"

    And I am on "Course 2" course homepage
    And I click on "Course gquiz" "link" in the "gquiz" "block"
    And I follow "Answer the questions"
    And I should not see "Acceptance test site" in the ".gquiz_form" "css_element"
    And I should see "C2" in the ".gquiz_form" "css_element"
    And I set the following fields to these values:
      | option b                         | 1        |
      | this is a simple multiple choice | option e |
    And I press "Submit your answers"
    ...
    And I follow "Answer the questions"
    And I should not see "Acceptance test site" in the ".gquiz_form" "css_element"
    And I should see "C3" in the ".gquiz_form" "css_element"
    And I set the following fields to these values:
      | option c                         | 1        |
      | this is a simple multiple choice | option d |
    And I press "Submit your answers"
    ...
    And I should see "1 (50.00 %)" in the "option b" "table_row"
    And I should see "1 (50.00 %)" in the "option c" "table_row"
    And I show chart data for the "multichoicesimple" gquiz
  ...
  Scenario: Site gquiz deletion hides gquiz block completely
    When I log in as "manager"
    And I am on site homepage
    And I turn editing mode on
    And I add the "gquiz" block
    And I add the "Main menu" block
    And I click on "Delete" "link" in the "Course gquiz" activity
    And I press "Yes"
    And I follow "Turn editing off"
    And I am on site homepage
    Then "gquiz" "block" should not exist
    And I am on "Course 1" course homepage
    And "gquiz" "block" should not exist
