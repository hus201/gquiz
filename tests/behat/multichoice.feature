@mod @mod_gquiz
Feature: Testing multichoice questions in gquiz
  In order to create gquizs
  As a teacher
  ...
  Background:
    ...
    And I am on the "Learning experience" "gquiz activity" page logged in as teacher1
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"

  @javascript
  Scenario: Non-rated single-answer multiple choice questions in gquiz
    When I add a "Multiple choice" question to the gquiz with:
    ...
    And I add a "Label" question to the gquiz with:
      | Contents | this is the first page of the gquiz |
    ...
    And I add a "Multiple choice" question to the gquiz with:
      ...
      | Required | 1 |
    And I add a "Label" question to the gquiz with:
      | Contents | this is the second page of the gquiz |
    And I select "Add a page break" from the "Add question" singleselect
    And I add a "Multiple choice" question to the gquiz with:
    ...
    And I add a "Label" question to the gquiz with:
      | Contents | this is the third page of the gquiz |
    And I log out
    And I am on the "Learning experience" "gquiz activity" page logged in as student1
    ...
    And I should see "this is the first page of the gquiz"
    And I should not see "this is the second page of the gquiz"
    And I should not see "this is the third page of the gquiz"
    ...
    And "Submit your answers" "button" should not exist
    And I should not see "this is the first page of the gquiz"
    And I should see "this is the second page of the gquiz"
    And I should not see "this is the third page of the gquiz"
    And I press "Next page"
    ...
    And I should see "this is the third page of the gquiz"
    ...
    And I am on the "Learning experience" "gquiz activity" page logged in as student2
    And I follow "Answer the questions"
    ...
    And I show chart data for the "multichoice3" gquiz
    ...
    And I click on "Edit questions" "link" in the "[role=main]" "css_element"
    And I open the action menu in "//div[contains(@class, 'gquiz_itemlist') and contains(.,'multichoice1')]" "xpath_element"
  ...
  @javascript
  Scenario: Non-rated multiple-answers multiple choice questions in gquiz
    # Create a gquiz with three pages, required and dependent questions.
    When I add a "Multiple choice" question to the gquiz with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
  ...
  @javascript
  Scenario: Non-rated single-answer dropdown multiple choice questions in gquiz
    When I add a "Multiple choice" question to the gquiz with:
      | Question         | this is a multiple choice 1 |
      | Label            | multichoice1                |
