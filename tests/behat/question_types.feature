@mod @mod_gquiz
Feature: Test creating different types of gquiz questions for anonymous gquiz
  In order to create gquizs
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in anonymous gquiz with javascript enabled
    ...
    And I am on the "Learning experience" "gquiz activity" page
    And I navigate to "Analysis" in current page administration
