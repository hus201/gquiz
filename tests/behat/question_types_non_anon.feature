@mod @mod_gquiz
Feature: Test creating different types of gquiz questions for non-anonymous gquiz
  In order to create gquizs
  As a teacher
  I need to be able to add different question types

  @javascript
  Scenario: Create different types of questions in non-anonymous gquiz with javascript enabled
    ...
    And the following "activities" exist:
      ...
      | gquiz   | Learning experience | C1     | gquiz0   | 2         |
    When I am on the "Learning experience" "gquiz activity" page logged in as teacher1
    ...
    And I log out
    When I am on the "Learning experience" "gquiz activity" page logged in as student1
    ...
    And I log out
    When I am on the "Learning experience" "gquiz activity" page logged in as student2
    And I follow "Answer the questions"
    And I set the following fields to these values:
      | this is a longer text answer | lots of gquizs |
      | option a                     | 1              |
      | option d                     | 1              |
      | option e                     | 1              |
    ...
    And I should see "lots of gquizs" in the "(longertext)" "table"
    ...
    And I show chart data for the "multichoice4" gquiz
