...
/**
 * Strings for component 'gquiz', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package mod_gquiz
...
$string['cannotaccess'] = 'You can only access this gquiz from a course';
...
$string['completed_gquizs'] = 'Submitted answers';
$string['complete_the_form'] = 'Answer the questions';
$string['completed'] = 'Completed';
$string['completedon'] = 'Completed on {$a}';
$string['completiondetail:submit'] = 'Submit gquiz';
$string['completionsubmit'] = 'View as completed if the gquiz is submitted';
$string['configallowfullanonymous'] = 'If set to \'yes\', users can complete a gquiz activity on the front page without being required to log in.';
...
$string['drop_gquiz'] = 'Remove from this course';
...
$string['email_notification_help'] = 'If enabled, teachers will receive notification of gquiz submissions.';
$string['emailteachermail'] = '{$a->username} has completed gquiz activity : \'{$a->gquiz}\'

You can view it here:

{$a->url}';
$string['emailteachermailhtml'] = '<p>{$a->username} has completed gquiz activity : <i>\'{$a->gquiz}\'</i>.</p>
...
$string['gquizcompleted'] = '{$a->username} completed {$a->gquizname}';
$string['gquiz:addinstance'] = 'Add a new gquiz';
$string['gquizclose'] = 'Allow answers to';
$string['gquiz:complete'] = 'Complete a gquiz';
$string['gquiz:createprivatetemplate'] = 'Create private template';
$string['gquiz:createpublictemplate'] = 'Create public template';
$string['gquiz:deletesubmissions'] = 'Delete completed submissions';
$string['gquiz:deletetemplate'] = 'Delete template';
$string['gquiz:edititems'] = 'Edit items';
$string['gquiz_is_not_for_anonymous'] = 'gquiz is not for anonymous';
$string['gquiz_is_not_open'] = 'The gquiz is not open';
$string['gquiz:mapcourse'] = 'Map courses to global gquizs';
$string['gquizopen'] = 'Allow answers from';
$string['gquiz:receivemail'] = 'Receive email notification';
$string['gquiz:view'] = 'View a gquiz';
$string['gquiz:viewanalysepage'] = 'View the analysis page after submit';
$string['gquiz:viewreports'] = 'View reports';
$string['file'] = 'File';
$string['filter_by_course'] = 'Filter by course';
$string['handling_error'] = 'Error occurred in gquiz module action handling';
...
$string['chosen_gquiz_response'] = 'Chosen gquiz response';
...
$string['indicator:cognitivedepth'] = 'gquiz cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a gquiz activity.';
$string['indicator:cognitivedepthdef'] = 'gquiz cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the gquiz activities during this analysis interval (Levels = No view, View, Submit)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'gquiz social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a gquiz activity.';
$string['indicator:socialbreadthdef'] = 'gquiz social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the gquiz activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
...
$string['insufficient_responses_help'] = 'For the gquiz to be anonymous, there must be at least 2 responses.';
$string['item_label'] = 'Label';
$string['item_name'] = 'Question';
$string['label'] = 'Label';
$string['labelcontents'] = 'Contents';
$string['mapcourseinfo'] = 'This is a site-wide gquiz that is available to all courses using the gquiz block. You can however limit the courses to which it will appear by mapping them. Search the course and map it to this gquiz.';
$string['mapcoursenone'] = 'No courses mapped. gquiz available to all courses';
$string['mapcourse'] = 'Map gquiz to courses';
$string['mapcourse_help'] = 'By default, gquiz forms created on your homepage are available site-wide
and will appear in all courses using the gquiz block. You can force the gquiz form to appear by making it a sticky block or limit the courses in which a gquiz form will appear by mapping it to specific courses.';
$string['mapcourses'] = 'Map gquiz to courses';
...
$string['messageprovider:message'] = 'gquiz reminder';
$string['messageprovider:submission'] = 'gquiz notifications';
$string['mode'] = 'Mode';
$string['modulename'] = 'General Quiz';
$string['modulename_help'] = 'The General Quiz activity enables a teacher to create a custom quiz for collecting gquiz from participants using a variety of question types including multiple choice, yes/no or text input.

gquiz responses may be anonymous if desired, and results may be shown to all participants or restricted to teachers only. Any gquiz activities on the site home may also be completed by non-logged-in users.

gquiz activities may be used
...
* For guest Quizs of course choices, school policies etc.
* For anti-bullying Quizs in which students can report incidents anonymously';
$string['modulename_link'] = 'mod/gquiz/view';
$string['modulenameplural'] = 'General Quiz';
...
$string['multiplesubmit_help'] = 'If enabled for anonymous Quizs, users can submit gquiz an unlimited number of times.';
$string['name'] = 'Name';
...
$string['only_one_captcha_allowed'] = 'Only one captcha is allowed in a gquiz';
$string['openafterclose'] = 'You have specified an open date after the close date';
$string['overview'] = 'Overview';
$string['page'] = 'Page';
$string['page-mod-gquiz-x'] = 'Any gquiz module page';
$string['page_after_submit'] = 'Completion message';
$string['pagebreak'] = 'Page break';
$string['pluginadministration'] = 'gquiz administration';
$string['pluginname'] = 'General Quiz';
$string['position'] = 'Position';
$string['previous_page'] = 'Previous page';
$string['privacy:metadata:completed'] = 'A record of the submissions to the gquiz';
...
$string['privacy:metadata:completed:userid'] = 'The ID of the user who completed the gquiz activity.';
...
$string['ready_gquizs'] = 'Ready gquizs';
$string['required'] = 'Required';
$string['resetting_data'] = 'Reset gquiz responses';
$string['resetting_gquizs'] = 'Resetting gquizs';
...
$string['search:activity'] = 'gquiz - activity information';
$string['search_course'] = 'Search course';
$string['searchcourses'] = 'Search courses';
$string['searchcourses_help'] = 'Search for the code or name of the course(s) that you wish to associate with this gquiz.';
...
$string['this_gquiz_is_already_submitted'] = 'You\'ve already completed this activity.';
...
$string['url_for_continue_help'] = 'After submitting the gquiz, a continue button is displayed, which links to the course page. Alternatively, it may link to the next activity if the URL of the activity is entered here.';
...
//Added By gquiz
$string['isgraded']='is Graded Question?';
$string['grade']='Grade';
