...
namespace mod_gquiz\analytics\indicator;
...
abstract class activity_base extends \core_analytics\local\indicator\community_of_inquiry_activity {
     ...
     * @return bool
     */
    protected function gquiz_viewed(\cm_info $cm, $contextid, $userid, $after = null) {
        // If stats are published any write action counts as viewed gquiz.
        if (!empty($this->instancedata[$cm->instance]->publish_stats)) {
            $user = (object)['id' => $userid];
            return $this->any_write_log($contextid, $user);
        }

        return parent::gquiz_viewed($cm, $contextid, $userid, $after);
    }
