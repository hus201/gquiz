...
/**
 * The mod_gquiz response submitted event.
 *
 * @package    mod_gquiz
...
/**
 * The mod_gquiz response submitted event class.
 *
 * This event is triggered when a gquiz response is submitted.
 *
...
class response_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventresponsesubmitted', 'mod_gquiz');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' submitted response for 'gquiz' activity with "
    ...
    public function get_url() {
        if ($this->anonymous) {
            return new \moodle_url('/mod/gquiz/show_entries.php', array('id' => $this->other['cmid'],
    ...
    protected function get_legacy_logdata() {
        if ($this->anonymous) {
            ...
            return array($this->courseid, 'gquiz', 'submit', 'view.php?id=' . $this->other['cmid'],
