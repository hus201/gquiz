...
/**
 * The mod_gquiz course module viewed event.
 *
 * @package    mod_gquiz
...
/**
 * The mod_gquiz course module viewed event class.
 *
...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init() {
        ...
        $this->data['objecttable'] = 'gquiz';
    }

    /**
     * Creates an instance from gquiz record
     *
     ...
     */
    public static function create_from_record($gquiz, $cm, $course) {
        $event = self::create(array(
            'objectid' => $gquiz->id,
            'context' => \context_module::instance($cm->id),
            'anonymous' => ($gquiz->anonymous == gquiz_ANONYMOUS_YES),
            'other' => array(
                'anonymous' => $gquiz->anonymous // Deprecated.
            )
        ));
    ...
    public static function get_objectid_mapping() {
        return array('db' => 'gquiz', 'restore' => 'gquiz');
    }
