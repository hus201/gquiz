...
/**
 * Contains the class for fetching the important dates in mod_gquiz for a given module instance and a user.
 *
 * @package   mod_gquiz
...
/**
 * Class for fetching the important dates in mod_gquiz for a given module instance and a user.
 *
 * @copyright 2021 Shamim Rezaie <shamim@moodle.com>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dates extends activity_dates {
    ...
    /**
     * Returns a list of important dates in mod_gquiz
     *
     * @return array
     */
