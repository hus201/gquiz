...
$PAGE->set_url('/mod/gquiz/item/captcha/print_captcha.php', array('id'=>$id));
...
if (!isset($SESSION->gquiz->item->captcha)) {
    print_error('captchanotset', 'gquiz');
}

$height = 40;
$charcount = $SESSION->gquiz->item->captcha->charcount;
...
$SESSION->gquiz->item->captcha->checkchar = $checkchar;
