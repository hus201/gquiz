YUI.add('moodle-mod_gquiz-dragdrop', function(Y) {
    var DRAGDROPNAME = 'mod_gquiz_dragdrop';
    var CSS = {
        DRAGAREA: '#gquiz_dragarea',
        DRAGITEMCLASS: 'gquiz_itemlist',
        DRAGITEM: 'div.gquiz_itemlist',
        DRAGLIST: '#gquiz_dragarea form',
    ...
    Y.extend(DRAGDROP, M.core.dragdrop, {
        ...
        initializer : function(params) {
            ...
            var groups = ['gquizitem'];

            var handletitle = M.util.get_string('move_item', 'gquiz');
            ...
            listitems = basenode.all(CSS.DRAGITEM).each(function(v) {
                var item_id = this.get_node_id(v.get('id')); //Get the id of the gquiz item.
        ...
        drag_drophit_handler : function(e) {
            ...
            if (!drop.hasClass(CSS.DRAGITEMCLASS)) {
                ...
                drop.all(CSS.DRAGITEM).each(function(v) {
                    childElement = v.one('.felement').one('[id^="gquiz_item_"]');
                    if (childElement) {
        ...
        save_item_order : function(cmid, itemorder, spinner) {
            ...
            Y.io(M.cfg.wwwroot + '/mod/gquiz/ajax.php', {
         ...
         *
         * @param id The dom id, f.g.: gquiz_item_22
         * @return int
         */
        get_node_id : function(id) {
            return Number(id.replace(/^.*gquiz_item_/i, ''));
        }
    ...
    M.mod_gquiz = M.mod_gquiz || {};
    M.mod_gquiz.init_dragdrop = function(params) {
